    ...
    try {
        ...
        stage('Code analysis') {
            ...
            if (isPRBuild) {
                ...
                sonarQubePRArguments = " -Dsonar.analysis.mode=preview -Dsonar.github.oauth=b085fb978953609ac301056e1ef317815d58c4d5 -Dsonar.github.repository=groupeseb/Kite -Dsonar.github.pullRequest=" + CHANGE_ID
            }
